...
#print the first letter og the mayor's name
print("First character of mayor name:", chicago_mayor[0])
print("Last character of mayor name:", chicago_mayor[-1])

#get John
print("Nickname of mayor is:", chicago_mayor[0:4])

#print son
print("last three characters of the mayor is:", chicago_mayor[4:])
print("last three characters of the mayor is:", chicago_mayor[-3:])

last_name = "Sanchez"
print("last name:", last_name[-3:])
print("first letter:", last_name[0:4])
